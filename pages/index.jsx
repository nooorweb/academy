...
import { homepageCarouselSlides } from "../data/homepageCarousel";
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-white">
        <ImageCarousel slides={homepageCarouselSlides} />
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-dark-text font-heading">Our Foundation</h2>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-6">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-background-gray rounded-2xl shadow-lg p-6 border-l-4 border-primary-blue hover:shadow-xl transition-all duration-300 card-hover"
            >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-background-gray rounded-2xl shadow-lg p-6 border-l-4 border-success-green hover:shadow-xl transition-all duration-300 card-hover"
            >
              <div className="flex items-center gap-3 mb-3">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-background-gray rounded-2xl shadow-lg p-6 border-l-4 border-accent-purple hover:shadow-xl transition-all duration-300 card-hover"
            >
              <div className="flex items-center gap-3 mb-3">
      ...
      <section className="py-16 bg-background-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-dark-text font-heading">Why Choose The Global English Academy?</h2>
            <p className="text-gray-text text-lg max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 lift-up"
              >
                <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg bg-gradient-to-br from-${feature.color}/10 to-${feature.color}/20`}>
                  <i className={`${feature.icon} text-2xl text-${feature.color}`}></i>
                </div>
                <h3 className="text-lg font-bold mb-3 text-dark-text font-heading">{feature.title}</h3>
